...
public class CusInfo {
	...
	public Scene getScene() {
		...
		LV.getItems().addAll("ROSE", "TULIPS", "LILY", "CARNATION", "LAVENDER",
				"ORCHID", "SUNFLOWER", "LILAC", "HYACINTH", "DAISIES",
				"FORGET ME NOT", "PRIMROSE", "CAMELLIAS", "CHERRY BLOSSOM",
				"BIRD OF PARADISE");

		final ComboBox CB1 = new ComboBox();
		CB1.getItems().addAll("WHITE", "BLUE", "RED", "PURPLE", "BLACK",
				"YELLOW", "ORANGE");

		final ComboBox CB2 = new ComboBox();
		CB2.getItems().addAll("ENGLAND", "AMSTERDAM", "MALAYSIA", "ICELAND",
				"AUSTRALIA");
